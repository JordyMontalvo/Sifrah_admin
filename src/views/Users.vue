    ...
    return {
      ...
      itemActions: [
        ...
        },
        {
          ...
          icon: "fas fa-ban",
          class: "is-warning",
          condition: function(item) { return item.status !== 'blocked' && item.status !== 'eliminated'; },
        },
        {
          key: "unblock",
          label: "Desbloquear",
          ...
          class: "is-success",
          condition: function(item) { return item.status === 'blocked'; },
        },
        {
          key: "eliminate",
          ...
          class: "is-danger",
          condition: function(item) { return item.status !== 'eliminated'; },
        },
        {
          key: "reactivate",
          label: "Reactivar",
